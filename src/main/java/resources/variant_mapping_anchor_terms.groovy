...
/*
    Need to update for more standardize nomencloture
    GeneSymbol              -   BRCA2
    WildNumberMutation      -   V600E
    RSID                    -   Rs113488022
    c.NumberAmino>Amino     -   c.1799T>A
    pWildNumberMutation     -   p.v600E
    NumberAmino>>Amino      -    1977T>A
    etc.
 ...
 */
    ...
    "hgvs_dna" {
        expressions = [
                ...
                //c.6591_6592del
                '((c|g)\\.)?\\d\\d\\d\\d?\\d?_\\d\\d\\d?\\d?\\d?del',
                //duplication
                // c.6591_6592dup
                '((c|g)\\.)?\\d\\d\\d\\d?\\d?_\\d\\d\\d?\\d?\\d?dup',
                //c.6591_6592dupCGATTATTCCA
                '((c|g)\\.)?\\d\\d\\d\\d?\\d?_\\d\\d\\d?\\d?\\d?dup(g|a|t|c){1,30}',
                //Deletion/insertion
                '((c|g)\\.)?\\d\\d\\d\\d?\\d?_\\d\\d\\d?\\d?\\d?delens(g|a|t|c){1,30}',
                '((c|g)\\.)?\\d\\d\\d\\d?\\d?_\\d\\d\\d?\\d?\\d?delins(g|a|t|c){1,30}',
                //1312delG
