...
public class LeoVariantMappingService {
    ...
    public LeoVariantMappingService() {
    ...
    public static void main(String[] args) {
        LeoVariantMappingService current_service = new LeoVariantMappingService();

        if (args.length == 0) {
            current_service.serviceConfigFile = new File[]{new File("config/ServiceConfig.groovy")};
            current_service.pipeline = new String[]{"gov.va.vinci.pipeline.variant_mapping_pipeline"};
    ...
    public static void printUsage() {
        CmdLineParser parser = new CmdLineParser(new LeoVariantMappingService());
        System.out.print("Usage: java " + LeoVariantMappingService.class.getCanonicalName());
