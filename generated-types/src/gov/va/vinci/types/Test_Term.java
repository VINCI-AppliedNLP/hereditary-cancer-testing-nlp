 ...
 * @generated */
public class Test_Term extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Test_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Test_Term() {/* intentionally empty block */}
   ...
   */
  public Test_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Test_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
