 ...
 * @generated */
public class HGVS_DNA extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(HGVS_DNA.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected HGVS_DNA() {/* intentionally empty block */}
   ...
   */
  public HGVS_DNA(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public HGVS_DNA(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
